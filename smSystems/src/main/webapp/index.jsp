				...
				<div class="carousel-inner" role="listbox">
					...
					<div class="item active" style="background-image: url(img/banner.jpg);">
						<div class="carousel-caption">
							<h2 data-wow-duration="700ms" data-wow-delay="500ms" class="wow bounceInDown animated">상상을현실로<span> 만들어드립니다</span>!</h2>
					...
					<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12 wow fadeInDown animated" data-wow-duration="500ms" data-wow-delay="300ms">
						<div class="contact-form">
							...
							<form action="#" id="contact-form">
								<!--<div class="input-group name-email">
									<div class="input-field">
										<input type="text" name="name" id="name" placeholder="당담자명" class="form-control">
									</div>
									<div class="input-field">
										<input type="email" name="email" id="email" placeholder="Email" class="form-control">
									</div>
								...
								<div class="input-field">
									<p style="font-weight: bold; font-size: 15px;">담당자명 <span style="color: red;">*</span></p>
									<input type="text" name="name" id="name" placeholder="name" class="form-control">
								</div>
								
								<div class="input-field mt-4">
									<p style="font-weight: bold; font-size: 15px;">연락처 <span style="color: red;">*</span></p>
									<input type="email" name="phone" id="phone" placeholder="phone" class="form-control">
								</div>
								
								<div class="input-field mt-4">
									<p style="font-weight: bold; font-size: 15px;">EMAIL <span style="color: red;">*</span></p>
									<input type="email" name="email" id="email" placeholder="Email" class="form-control">
								</div>
								
								<div class="input-field mt-4">
									<p style="font-weight: bold; font-size: 15px;">카카오톡아이디</p>
									<input type="email" name="kakaoId" id="kakaoId" placeholder="kakaoID" class="form-control">
								</div>
								
								
								
								<div class="input-group mt-4">
									<p class="mt-4" style="font-weight: bold; font-size: 15px;">제작예산 <span style="color: red;">*</span></p>
									<div class="radio">
						                <label for="rb1">
						                    <input type="radio" id="rb1" name="rb">
						                	<p style="font-size: 15px;">150만원이하</p>
						                </label>
						            </div>
						            <div class="radio">
						                <label for="rb2">
						                    <input type="radio" id="rb2" name="rb">
						                	<p style="font-size: 15px;">300만원이하</p>
						                </label>
						            </div>
						            <div class="radio">
						                <label for="rb3">
						                    <input type="radio" id="rb3" name="rb">
						                	<p style="font-size: 15px;">500만원이하</p>
						                </label>
						            </div>
						            <div class="radio">
						                <label for="rb4">
						                    <input type="radio" id="rb4" name="rb">
						                	<p style="font-size: 15px;">1000만원이하</p>
						                </label>
						            </div>
						            <div class="radio">
						                <label for="rb5">
						                    <input type="radio" id="rb5" name="rb">
						                	<p style="font-size: 15px;">1000만원이상</p>
						                </label>
						            </div>
					            </div>
					            
					            <div class="input-group mt-4">
									<p style="font-weight: bold; font-size: 15px;">문의내용 <span style="color: red;">*</span></p>
									<textarea name="message" id="message" placeholder="문의내용을 입력해주세요" style="height: 150px;" class="form-control"></textarea>
								</div>
								
								<div class="input-group">
									<input type="submit" id="form-submit" class="pull-right" value="문의하기">
								</div>
							</form>
						</div>
					</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12" style="width: 100%; height: 100%;">
						<p class="text-center">에스엠시스템즈 | 대표자 : 홍수민 | 대표번호 : 010-8241-4987</p>
						<p class="text-center">주소:서울특별시 강서구 화곡동 19-6 401호</p>
						<p class="copyright text-center">
							Copyright © 2021 <a href="http://themefisher.com/">Themefisher</a>. All rights reserved.
						</p>
					</div>
				</div>
			</div>
				...
				$('#contact-form').validate({
					...
					messages: {
						name: {
							...
							minlength: "두글자이상 입력해주세요."
						},
						email: {
							required: "입력된 메일이없습니다."
						},
						message: {
							required: "입력된 메세지가없습니다",
